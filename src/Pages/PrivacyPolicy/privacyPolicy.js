...
const PrivacyPolicy = (props) => {
    ...
    return (
        <div>
            <img src={blueSquares} style={{ zIndex: "-1", position: "absolute", top: "2000px", right: "150px" }} />

            <Row className="my-3" >
                <Link to="/"> <h3>Home</h3> </Link>
            </Row>
            <Row className="my-3" style={{ justifyContent: "center" }}>
                <h3>DIP Applications, Ltd.</h3>
            </Row>
            <Row className="my-3" style={{ justifyContent: "center" }}>
            ...
            <Row>
                <p>
                    Welcome to the Privacy Policy of DIP Applications, Ltd.
            ...
            <Row>
                <div>DIP Applications, Ltd.</div>
                <div>10 Ben Avigdor,</div>
                <div>Tel Aviv-Yafo, Israel</div>
                <div>alice@i-dip.com</div>
                <div>https://www.i-dip.com</div>
            </Row>
